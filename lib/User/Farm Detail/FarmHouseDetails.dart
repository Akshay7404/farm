...
Widget FarmHouse_Details(PropertyModel propertyModel) {
  return Row(
    children: [
      Expanded(
        child: Column(
...
Widget RentAndFees(PropertyModel propertyModel) {
...
Widget Farm_Amenities(PropertyModel propertyModel) {
  return Row(children: [
    Expanded(
      child: Column(
        children: [
...
Widget Farm_Facilities(PropertyModel propertyModel) {
  return Row(children: [
    Expanded(
      child: Column(
        children: [
...
Widget Farm_Guidelines(PropertyModel propertyModel) {
  return Row(children: [
    Expanded(
      child: Column(
        children: [
