...
class FarmPhotos extends StatefulWidget {
  const FarmPhotos({Key? key}) : super(key: key);

  @override
  State<FarmPhotos> createState() => _FarmPhotosState();
}

class _FarmPhotosState extends State<FarmPhotos> {
  final List HotelImg = [
